...
* [Process](https://github.com/joelparkerhenderson/architecture-decision-record) ⭐ 16,818 | 🐛 10 | 📅 2026-09-01
* Templates
  * [Atlassian](https://www.atlassian.com/software/confluence/templates/decision)
...
| Test     | <https://github.com/abhivaikar/howtheytest> ⭐ 6,864 \| 🐛 4 \| 🌐 TypeScript \| 📅 2026-08-22 |
...
| Link                                                                                                   | Description                                                                                                                                                      |
| ------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [OpenProject](https://github.com/opf/openproject) ⭐ 16,015 \| 🐛 252 \| 🌐 Ruby \| 📅 2026-09-03       | OpenProject is the leading open source project management software.                                                                                              |
...
| Link                                                                                                        | Description                                                                         |
| ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| [focalboard](https://github.com/mattermost/focalboard) ⭐ 26,448 \| 🐛 784 \| 🌐 TypeScript \| 📅 2026-05-18 | Focalboard is an open source, self-hosted alternative to Trello, Notion, and Asana. |
| [react-kanban](https://github.com/markusenglund/react-kanban) ⚠️ Archived                                   | A server-rendered React app inspired by Trello.                                     |
| [wekan](https://github.com/wekan/wekan) ⭐ 21,072 \| 🐛 284 \| 🌐 JavaScript \| 📅 2026-09-02                | Open Source kanban                                                                  |
| [kanboard](https://github.com/kanboard/kanboard) ⭐ 9,847 \| 🐛 159 \| 🌐 PHP \| 📅 2026-08-29               | Kanban project management software                                                  |
...
| [Bookstack](https://github.com/BookStackApp/BookStack) ⭐ 19,019 \| 🐛 2 \| 🌐 PHP \| 📅 2026-09-03 | A platform to create documentation/wiki content built with PHP & Laravel                  |
| [Mediawiki](https://github.com/wikimedia/mediawiki) ⭐ 5,160 \| 🐛 0 \| 🌐 PHP \| 📅 2026-09-03     | The collaborative editing software that runs Wikipedia.                                   |
...
| [Mailspring](https://github.com/Foundry376/Mailspring) ⭐ 17,769 \| 🐛 22 \| 🌐 TypeScript \| 📅 2026-09-02 | A beautiful, fast and fully open source mail client for Mac, Windows and Linux.                               |
...
| [K9](https://github.com/k9mail/k-9) ⭐ 13,959 \| 🐛 1,056 \| 🌐 Kotlin \| 📅 2026-09-03                     | K-9 Mail – Open Source Email App for Android                                                                  |
...
| Link                                                                                                             | Description                                                                             |
| ---------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| [activitywatch](https://github.com/ActivityWatch/activitywatch) ⭐ 18,795 \| 🐛 193 \| 🌐 Python \| 📅 2026-09-01 | Records what you do so that you can know how you've spent your time.                    |
...
| [pomotroid](https://github.com/Splode/pomotroid) ⭐ 5,469 \| 🐛 127 \| 🌐 Rust \| 📅 2026-08-02                   | Simple and visually-pleasing Pomodoro timer                                             |
| [pomatez](https://github.com/roldanjr/pomatez) ⭐ 4,884 \| 🐛 167 \| 🌐 TypeScript \| 📅 2026-05-19               | Stay Focused. Take a Break.                                                             |
| [gnome-pomodoro](https://github.com/gnome-pomodoro/gnome-pomodoro) ⭐ 2,241 \| 🐛 59 \| 🌐 Vala \| 📅 2026-08-25  | A time management utility for GNOME based on the pomodoro technique!                    |
| [Goodtime](https://github.com/adrcotfas/Goodtime) ⭐ 1,885 \| 🐛 67 \| 🌐 Kotlin \| 📅 2026-09-03                 | productivity app for Android                                                            |
...
| Link                                                                                                                          | Description                                                                                                                                |
| ----------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| [Invoiceninja](https://github.com/invoiceninja/invoiceninja) ⭐ 10,048 \| 🐛 939 \| 🌐 PHP \| 📅 2026-09-03                    | Invoices, Expenses and Tasks built with Laravel and Flutter                                                                                |
| [Wakatime](https://github.com/wakatime)                                                                                       | Dashboards for developers, powered by open source IDE plugins.                                                                             |
| [Activitywatch](https://github.com/ActivityWatch/activitywatch) ⭐ 18,795 \| 🐛 193 \| 🌐 Python \| 📅 2026-09-01              | Records what you do so that you can know how you've spent your time.                                                                       |
| [Super-productivity](https://github.com/johannesjo/super-productivity) ⭐ 21,776 \| 🐛 1,472 \| 🌐 TypeScript \| 📅 2026-09-03 | To-do list & time tracker for programmers and other digital workers with Jira, Github, and Gitlab integration                              |
| [Toggldesktop](https://github.com/toggl-open-source/toggldesktop) ⚠️ Archived                                                 | Toggl Desktop is a Toggl time tracking client                                                                                              |
| [Kimai2](https://github.com/kevinpapst/kimai2) ⭐ 4,955 \| 🐛 343 \| 🌐 PHP \| 📅 2026-09-03                                   | Kimai v2 is a web-based multiuser time-tracking application                                                                                |
| [ShareX](https://github.com/ShareX/ShareX) ⭐ 39,432 \| 🐛 660 \| 🌐 C# \| 📅 2026-09-02                                       | ShareX is a free and open source program that lets you capture or record any area of your screen and share it with a single press of a key |

### Mentoring

| Link                                                                                                                                | Description                                                                                                                                                                            |                             |
| ----------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- |
| [developer-roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 366,209 \| 🐛 3 \| 🌐 TypeScript \| 📅 2026-09-03         | Roadmap to becoming a web developer in 2021                                                                                                                                            |                             |
...
| [ossu/computer-science](https://github.com/ossu/computer-science) ⭐ 208,656 \| 🐛 27 \| 🌐 HTML \| 📅 2026-07-14                    | Path to a free self-taught education in Computer Science!                                                                                                                              |                             |
...
| [awesome-courses](https://github.com/prakhar1989/awesome-courses) ⭐ 70,856 \| 🐛 65 \| 📅 2023-05-04                                | List of awesome university courses for learning Computer Science!                                                                                                                      |                             |
...
| [System design primer](https://github.com/donnemartin/system-design-primer) ⭐ 367,626 \| 🐛 613 \| 🌐 Python \| 📅 2026-03-20       | Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.                                                                               |                             |
...
| [awesome-startup](https://github.com/KrishMunot/awesome-startup) ⭐ 2,340 \| 🐛 1 \| 📅 2026-08-26                                        | All the required resources to build your own startup                                                                   |
...
| [engineering-blogs](https://github.com/kilimchoi/engineering-blogs) ⭐ 38,569 \| 🐛 151 \| 🌐 Ruby \| 📅 2024-08-21                       | A curated list of engineering blogs                                                                                    |
...
# [Laws to live by](https://github.com/dwmkerr/hacker-laws) ⭐ 27,279 | 🐛 153 | 🌐 HTML | 📅 2026-09-02
