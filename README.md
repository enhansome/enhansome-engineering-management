...
* [Process](https://github.com/joelparkerhenderson/architecture-decision-record) ⭐ 16,841 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-05
* Templates
  * [Atlassian](https://www.atlassian.com/software/confluence/templates/decision)
...
| Link                                                                                                   | Description                                                                                                                                                      |
| ------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [OpenProject](https://github.com/opf/openproject) ⭐ 16,040 \| 🐛 267 \| 🌐 Ruby \| 📅 2026-09-07       | OpenProject is the leading open source project management software.                                                                                              |
...
| Link                                                                                                        | Description                                                                         |
| ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| [focalboard](https://github.com/mattermost/focalboard) ⭐ 26,450 \| 🐛 784 \| 🌐 TypeScript \| 📅 2026-05-18 | Focalboard is an open source, self-hosted alternative to Trello, Notion, and Asana. |
| [react-kanban](https://github.com/markusenglund/react-kanban) ⚠️ Archived                                   | A server-rendered React app inspired by Trello.                                     |
| [wekan](https://github.com/wekan/wekan) ⭐ 21,073 \| 🐛 281 \| 🌐 JavaScript \| 📅 2026-09-07                | Open Source kanban                                                                  |
...
| [Bookstack](https://github.com/BookStackApp/BookStack) ⭐ 19,027 \| 🐛 3 \| 🌐 PHP \| 📅 2026-09-07 | A platform to create documentation/wiki content built with PHP & Laravel                  |
| [Mediawiki](https://github.com/wikimedia/mediawiki) ⭐ 5,167 \| 🐛 0 \| 🌐 PHP \| 📅 2026-09-07     | The collaborative editing software that runs Wikipedia.                                   |
...
| [Mailspring](https://github.com/Foundry376/Mailspring) ⭐ 17,778 \| 🐛 26 \| 🌐 TypeScript \| 📅 2026-09-07 | A beautiful, fast and fully open source mail client for Mac, Windows and Linux.                               |
...
| [K9](https://github.com/k9mail/k-9) ⭐ 13,974 \| 🐛 1,057 \| 🌐 Kotlin \| 📅 2026-09-05                     | K-9 Mail – Open Source Email App for Android                                                                  |
...
| Link                                                                                                             | Description                                                                             |
| ---------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| [activitywatch](https://github.com/ActivityWatch/activitywatch) ⭐ 18,835 \| 🐛 187 \| 🌐 Python \| 📅 2026-09-06 | Records what you do so that you can know how you've spent your time.                    |
...
| [pomotroid](https://github.com/Splode/pomotroid) ⭐ 5,480 \| 🐛 128 \| 🌐 Rust \| 📅 2026-08-02                   | Simple and visually-pleasing Pomodoro timer                                             |
| [pomatez](https://github.com/roldanjr/pomatez) ⭐ 4,884 \| 🐛 167 \| 🌐 TypeScript \| 📅 2026-05-19               | Stay Focused. Take a Break.                                                             |
...
| Link                                                                                                                          | Description                                                                                                                                |
| ----------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| [Invoiceninja](https://github.com/invoiceninja/invoiceninja) ⭐ 10,060 \| 🐛 941 \| 🌐 PHP \| 📅 2026-09-05                    | Invoices, Expenses and Tasks built with Laravel and Flutter                                                                                |
| [Wakatime](https://github.com/wakatime)                                                                                       | Dashboards for developers, powered by open source IDE plugins.                                                                             |
| [Activitywatch](https://github.com/ActivityWatch/activitywatch) ⭐ 18,835 \| 🐛 187 \| 🌐 Python \| 📅 2026-09-06              | Records what you do so that you can know how you've spent your time.                                                                       |
| [Super-productivity](https://github.com/johannesjo/super-productivity) ⭐ 21,864 \| 🐛 1,469 \| 🌐 TypeScript \| 📅 2026-09-07 | To-do list & time tracker for programmers and other digital workers with Jira, Github, and Gitlab integration                              |
| [Toggldesktop](https://github.com/toggl-open-source/toggldesktop) ⚠️ Archived                                                 | Toggl Desktop is a Toggl time tracking client                                                                                              |
| [Kimai2](https://github.com/kevinpapst/kimai2) ⭐ 4,962 \| 🐛 347 \| 🌐 PHP \| 📅 2026-09-07                                   | Kimai v2 is a web-based multiuser time-tracking application                                                                                |
| [ShareX](https://github.com/ShareX/ShareX) ⭐ 39,479 \| 🐛 647 \| 🌐 C# \| 📅 2026-09-07                                       | ShareX is a free and open source program that lets you capture or record any area of your screen and share it with a single press of a key |

### Mentoring

| Link                                                                                                                                | Description                                                                                                                                                                            |                             |
| ----------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- |
| [developer-roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 366,481 \| 🐛 3 \| 🌐 TypeScript \| 📅 2026-09-07         | Roadmap to becoming a web developer in 2021                                                                                                                                            |                             |
...
| [ossu/computer-science](https://github.com/ossu/computer-science) ⭐ 208,795 \| 🐛 27 \| 🌐 HTML \| 📅 2026-07-14                    | Path to a free self-taught education in Computer Science!                                                                                                                              |                             |
...
| [awesome-courses](https://github.com/prakhar1989/awesome-courses) ⭐ 70,949 \| 🐛 65 \| 📅 2023-05-04                                | List of awesome university courses for learning Computer Science!                                                                                                                      |                             |
...
| [System design primer](https://github.com/donnemartin/system-design-primer) ⭐ 368,495 \| 🐛 613 \| 🌐 Python \| 📅 2026-03-20       | Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.                                                                               |                             |
...
| [awesome-cto](https://github.com/kuchin/awesome-cto) ⭐ 35,419 \| 🐛 4 \| 📅 2026-03-02                                                   | A curated and opinionated list of resources for Chief Technology Officers, with the emphasis on startups               |
...
| [engineering-management](https://github.com/charlax/engineering-management) ⭐ 8,357 \| 🐛 1 \| 🌐 Shell \| 📅 2026-07-19                 | A collection of inspiring resources related to engineering management and tech leadership                              |
...
| [engineering-blogs](https://github.com/kilimchoi/engineering-blogs) ⭐ 38,584 \| 🐛 151 \| 🌐 Ruby \| 📅 2024-08-21                       | A curated list of engineering blogs                                                                                    |
