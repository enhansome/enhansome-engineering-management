...
* [Process](https://github.com/joelparkerhenderson/architecture-decision-record) ⭐ 16,832 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-05
* Templates
  * [Atlassian](https://www.atlassian.com/software/confluence/templates/decision)
...
| Link                                                                                                   | Description                                                                                                                                                      |
| ------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [OpenProject](https://github.com/opf/openproject) ⭐ 16,029 \| 🐛 258 \| 🌐 Ruby \| 📅 2026-09-05       | OpenProject is the leading open source project management software.                                                                                              |
...
| [wekan](https://github.com/wekan/wekan) ⭐ 21,074 \| 🐛 281 \| 🌐 JavaScript \| 📅 2026-09-05                | Open Source kanban                                                                  |
...
| Link                                                                                                                | Description                                                       |
| ------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| [git-standup](https://github.com/kamranahmedse/git-standup) ⭐ 7,850 \| 🐛 24 \| 🌐 Shell \| 📅 2025-07-07           | Recall what you did on the last working day.                      |
...
| [Bookstack](https://github.com/BookStackApp/BookStack) ⭐ 19,024 \| 🐛 2 \| 🌐 PHP \| 📅 2026-09-05 | A platform to create documentation/wiki content built with PHP & Laravel                  |
| [Mediawiki](https://github.com/wikimedia/mediawiki) ⭐ 5,164 \| 🐛 0 \| 🌐 PHP \| 📅 2026-09-05     | The collaborative editing software that runs Wikipedia.                                   |
...
| [Mailspring](https://github.com/Foundry376/Mailspring) ⭐ 17,774 \| 🐛 24 \| 🌐 TypeScript \| 📅 2026-09-04 | A beautiful, fast and fully open source mail client for Mac, Windows and Linux.                               |
...
| [K9](https://github.com/k9mail/k-9) ⭐ 13,961 \| 🐛 1,060 \| 🌐 Kotlin \| 📅 2026-09-04                     | K-9 Mail – Open Source Email App for Android                                                                  |
...
| Link                                                                                                             | Description                                                                             |
| ---------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| [activitywatch](https://github.com/ActivityWatch/activitywatch) ⭐ 18,812 \| 🐛 187 \| 🌐 Python \| 📅 2026-09-04 | Records what you do so that you can know how you've spent your time.                    |
...
| [pomotroid](https://github.com/Splode/pomotroid) ⭐ 5,472 \| 🐛 128 \| 🌐 Rust \| 📅 2026-08-02                   | Simple and visually-pleasing Pomodoro timer                                             |
...
| Link                                                                                                                          | Description                                                                                                                                |
| ----------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| [Invoiceninja](https://github.com/invoiceninja/invoiceninja) ⭐ 10,055 \| 🐛 940 \| 🌐 PHP \| 📅 2026-09-05                    | Invoices, Expenses and Tasks built with Laravel and Flutter                                                                                |
| [Wakatime](https://github.com/wakatime)                                                                                       | Dashboards for developers, powered by open source IDE plugins.                                                                             |
| [Activitywatch](https://github.com/ActivityWatch/activitywatch) ⭐ 18,812 \| 🐛 187 \| 🌐 Python \| 📅 2026-09-04              | Records what you do so that you can know how you've spent your time.                                                                       |
| [Super-productivity](https://github.com/johannesjo/super-productivity) ⭐ 21,816 \| 🐛 1,462 \| 🌐 TypeScript \| 📅 2026-09-05 | To-do list & time tracker for programmers and other digital workers with Jira, Github, and Gitlab integration                              |
| [Toggldesktop](https://github.com/toggl-open-source/toggldesktop) ⚠️ Archived                                                 | Toggl Desktop is a Toggl time tracking client                                                                                              |
| [Kimai2](https://github.com/kevinpapst/kimai2) ⭐ 4,957 \| 🐛 341 \| 🌐 PHP \| 📅 2026-09-03                                   | Kimai v2 is a web-based multiuser time-tracking application                                                                                |
| [ShareX](https://github.com/ShareX/ShareX) ⭐ 39,449 \| 🐛 652 \| 🌐 C# \| 📅 2026-09-05                                       | ShareX is a free and open source program that lets you capture or record any area of your screen and share it with a single press of a key |

### Mentoring

| Link                                                                                                                                | Description                                                                                                                                                                            |                             |
| ----------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- |
| [developer-roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 366,338 \| 🐛 4 \| 🌐 TypeScript \| 📅 2026-09-04         | Roadmap to becoming a web developer in 2021                                                                                                                                            |                             |
...
| [ossu/computer-science](https://github.com/ossu/computer-science) ⭐ 208,731 \| 🐛 27 \| 🌐 HTML \| 📅 2026-07-14                    | Path to a free self-taught education in Computer Science!                                                                                                                              |                             |
...
| [awesome-courses](https://github.com/prakhar1989/awesome-courses) ⭐ 70,897 \| 🐛 65 \| 📅 2023-05-04                                | List of awesome university courses for learning Computer Science!                                                                                                                      |                             |
...
| [System design primer](https://github.com/donnemartin/system-design-primer) ⭐ 368,039 \| 🐛 613 \| 🌐 Python \| 📅 2026-03-20       | Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.                                                                               |                             |
...
| [awesome-startup](https://github.com/KrishMunot/awesome-startup) ⭐ 2,342 \| 🐛 3 \| 📅 2026-08-26                                        | All the required resources to build your own startup                                                                   |
...
| [engineering-blogs](https://github.com/kilimchoi/engineering-blogs) ⭐ 38,579 \| 🐛 151 \| 🌐 Ruby \| 📅 2024-08-21                       | A curated list of engineering blogs                                                                                    |
...
# [Laws to live by](https://github.com/dwmkerr/hacker-laws) ⭐ 27,278 | 🐛 153 | 🌐 HTML | 📅 2026-09-02
